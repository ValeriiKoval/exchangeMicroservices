package com.microservice.exchangeservice.security.filter;

import com.microservice.exchangeservice.security.CustomUserDetails;
...
public class HeaderRoleFilter extends OncePerRequestFilter {
    ...
    private CustomUserDetails parseCustomUserDetails(final HttpServletRequest request) {
        ...
        if (headerAuth == null || userId == null) {
            throw new AuthenticationCredentialsNotFoundException("Roles or userId headers not found in request.");
        }
